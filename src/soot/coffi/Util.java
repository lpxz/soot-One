...
import lptools.FindRealMain4Dacapo;
import soot.tagkit.*;
import soot.*;
...
public class Util
{
    ...
    public void resolveFromClassFile(SootClass aClass, InputStream is, List references)
    {
        ...
        // Load up class file, and retrieve bclass from class manager.
        {
            ...
            for(String exclude: PhantomSupport.phantomList)// added by lpxz, help type checker to avoid analyzing/loading them:
            {
