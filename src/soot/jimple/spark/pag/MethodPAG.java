...
public final class MethodPAG {
    ...
    public void addToPAG( Context varNodeParameter ) {
            if( !hasBeenBuilt ) 
        	{
        	       return; // phantom or excluded classes. we do not model them in PAG.   
        	       // added by lpxz to bypass bugs. originally it was "throw new RuntimeException".
        	}
